package aze.motion.specials 
{
	...
	public class PropertyTint extends EazeSpecial
	{
		...
		override public function update(decimalPercent:Number, isComplete:Boolean):void
		{
			...
			t.redMultiplier = start.redMultiplier + delta.redMultiplier * decimalPercent;
			t.greenMultiplier = start.greenMultiplier + delta.greenMultiplier * decimalPercent;
			t.blueMultiplier = start.blueMultiplier + delta.blueMultiplier * decimalPercent;
			t.redOffset = start.redOffset + delta.redOffset * decimalPercent;
			t.greenOffset = start.greenOffset + delta.greenOffset * decimalPercent;
			t.blueOffset = start.blueOffset + delta.blueOffset * decimalPercent;
